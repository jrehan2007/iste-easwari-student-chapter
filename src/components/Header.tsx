...
export default function Header() {
  ...
  <h1 className="header-chapter-title w-full font-display text-[15px] font-semibold tracking-wide leading-tight xs:text-lg sm:w-auto sm:text-2xl sm:leading-tight md:text-3xl lg:text-4xl">
