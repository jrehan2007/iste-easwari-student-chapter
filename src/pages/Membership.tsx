  ...
  return (
    <div className="container-page py-10 sm:py-14">
      ...
      <div className="mt-8 sm:mt-10 grid gap-6 sm:gap-8 lg:grid-cols-[1.25fr_1fr]">
        ...
        <aside className="h-fit rounded-sm border-2 border-gold bg-[#E8F1F4] p-5 sm:p-7 text-ink shadow-sm dark:bg-ink dark:text-white">
          {open ? (
            <>
              <p className="text-xs sm:text-sm font-semibold tracking-widest text-gold-deep dark:text-gold-light">MEMBERSHIP</p>
              <p className="font-display mt-2 text-3xl xs:text-4xl sm:text-5xl font-semibold">{s?.price_label}</p>
